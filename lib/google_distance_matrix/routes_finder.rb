module GoogleDistanceMatrix
  ...
  class RoutesFinder
    ...
    # Public: Finds shortest route by distance to a place.
    #
    ...
    # Public: Finds longest route by distance to a place.
    #
    # place - The place, or object place was built from, you want the longest route to
    #
    # Returns shortest route, or nil if no routes had status ok
    def longest_route_by_distance_to(place_or_object_place_was_built_from)
      routes = routes_for place_or_object_place_was_built_from
      select_ok_routes(routes).max_by &:distance_in_meters
    end    
    ...
    # place - The place, or object place was built from, you want the longest route to
    #
    # Returns longest route, fails if any of the routes are not ok
    def longest_route_by_distance_to!(place_or_object_place_was_built_from)
      routes_for!(place_or_object_place_was_built_from).max_by &:distance_in_meters
    end

    # Public: Finds shortest route by duration to a place.
    #
    # place - The place, or object place was built from, you want the shortest route to
    #
    # Returns shortest route, or nil if no routes had status ok
    ...
    # Public: Finds longest route by duration to a place.
    #
    # place - The place, or object place was built from, you want the longest route to
    #
    # Returns shortest route, or nil if no routes had status ok
    def longest_route_by_duration_to(place_or_object_place_was_built_from)
      routes = routes_for place_or_object_place_was_built_from
      select_ok_routes(routes).max_by &:duration_in_seconds
    end
    ...
    # Returns shortest route, fails if any of the routes are not ok
    def longest_route_by_duration_to!(place_or_object_place_was_built_from)
      routes_for!(place_or_object_place_was_built_from).max_by &:duration_in_seconds
    end
